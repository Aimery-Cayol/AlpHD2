      ...
      <div className="bg-white rounded-3xl p-8 max-w-lg w-full shadow-2xl border border-slate-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ...
          <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
            ...
            <p className="text-xs text-slate-600">Ajustez la position du soleil dans <strong>Paramètres → Azimuth</strong>.</p>
          </div>
        ...
        <button onClick={onClose} className="w-full py-4 bg-blue-600 text-white rounded-2xl text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-blue-700 shadow-lg shadow-blue-200">Continuer</button>
      </div>
    </div>
  );
}

// --- DONNÉES COMPLÈTES RÉTABLIES ---
const MOUNTAIN_TREE = [
  {
    ...
    children: [
      {
        ...
        children: [
          { 
            id: "tour", 
            name: "Aiguille du Tour (3540m)", 
            altitude: "3540m", 
            c2c: "https://www.camptocamp.org/waypoints/37508/fr/aiguille-du-tour",
            description: "Sommet très classique, point de vue exceptionnel sur le bassin d'Argentière.",
            dalles: [{ path: "meshes/1010_6552.drc", x: 1010, y: 6552 }] 
          },
          { 
            id: "chardonnet", 
            name: "Aiguille du Chardonnet (3824m)", 
            altitude: "3824m", 
            c2c: "https://www.camptocamp.org/waypoints/37433/fr/aiguille-du-chardonnet",
            description: "Une des plus belles arêtes mixtes du massif : l'arête Forbes.",
            dalles: [
              { path: "meshes/1009_6549.drc", x: 1009, y: 6549 }, 
              { path: "meshes/1009_6550.drc", x: 1009, y: 6550 }, 
              { path: "meshes/1010_6549.drc", x: 1010, y: 6549 }, 
              { path: "meshes/1010_6550.drc", x: 1010, y: 6550 }, 
              { path: "meshes/1011_6550.drc", x: 1011, y: 6550 }
            ] 
          },
        ],
      },
      {
        ...
        children: [
          { 
            id: "verte", 
            name: "Aiguille Verte (4122m)", 
            altitude: "4122m", 
            c2c: "https://www.camptocamp.org/waypoints/37435/fr/aiguille-verte",
            description: "Avant la Verte on est alpiniste, après la Verte on devient montagnard.",
            waypoints: [{name: "Couloir Whymper", type: "Couloir"}, {name: "Arête des Grands Montets", type: "Arête"}],
            dalles: [
                { path: "meshes/1006_6545-12.drc", x: 1006, y: 6545 }, { path: "meshes/1006_6546.drc", x: 1006, y: 6546 }, 
                { path: "meshes/1006_6547.drc", x: 1006, y: 6547 }, { path: "meshes/1007_6545.drc", x: 1007, y: 6545 }, 
                { path: "meshes/1007_6546.drc", x: 1007, y: 6546 }, { path: "meshes/1007_6547.drc", x: 1007, y: 6547 },
                { path: "meshes/1008_6546.drc", x: 1008, y: 6546 }
            ] 
          },
          { 
            id: "drus", 
            name: "Les Drus (3754m)", 
            altitude: "3754m", 
            c2c: "https://www.camptocamp.org/waypoints/37431/fr/les-drus",
            description: "Célèbre pour sa face Ouest vertigineuse et le Pilier Bonatti.",
            dalles: [{ path: "meshes/1006_6545-12.drc", x: 1006, y: 6545 }] 
          },
          { 
            id: "droites", 
            name: "Les Droites (4001m)", 
            altitude: "4001m", 
            c2c: "https://www.camptocamp.org/waypoints/37434/fr/les-droites",
            description: "Un mur de glace et de roc dominant le bassin d'Argentière.",
            dalles: [
                { path: "meshes/1008_6545.drc", x: 1008, y: 6545 }, { path: "meshes/1008_6546.drc", x: 1008, y: 6546 }, 
                { path: "meshes/1009_6545.drc", x: 1009, y: 6545 }, { path: "meshes/1009_6546.drc", x: 1009, y: 6546 }
            ] 
          },
          { 
            id: "courtes", 
            name: "Les Courtes (3856m)", 
            altitude: "3856m",
            c2c: "https://www.camptocamp.org/waypoints/37432/fr/les-courtes",
            description: "Célèbre pour sa face Nord rectiligne.",
            dalles: [{ path: "meshes/1009_6544.drc", x: 1009, y: 6544 }, { path: "meshes/1010_6544.drc", x: 1010, y: 6544 }, { path: "meshes/1010_6545.drc", x: 1010, y: 6545 }] 
          },
          { 
            id: "moine", 
            name: "Aiguille du Moine (3412m)", 
            altitude: "3412m",
            c2c: "https://www.camptocamp.org/waypoints/37505/fr/aiguille-du-moine",
            description: "Une pyramide de granit parfait au centre du massif.",
            dalles: [{ path: "meshes/1006_6543-12.drc", x: 1006, y: 6543 }, { path: "meshes/1006_6544.drc", x: 1006, y: 6544 }, { path: "meshes/1007_6543.drc", x: 1007, y: 6543 }, { path: "meshes/1007_6544.drc", x: 1007, y: 6544 }] 
          },
        ],
      },
      {
        ...
        children: [
          { 
            id: "midi", 
            name: "Aiguille du Midi (3842m)", 
            altitude: "3842m",
            c2c: "https://www.camptocamp.org/waypoints/37402/fr/aiguille-du-midi",
            description: "Porte d'entrée de la haute montagne, accessible en téléphérique.",
            dalles: [{ path: "meshes/1000_6539.drc", x: 1000, y: 6539 }, { path: "meshes/1001_6539.drc", x: 1001, y: 6539 }, { path: "meshes/1001_6540.drc", x: 1001, y: 6540 }] 
          },
          { 
            id: "plan", 
            name: "Aiguille du Plan (3673m)", 
            altitude: "3673m",
            c2c: "https://www.camptocamp.org/waypoints/37427/fr/aiguille-du-plan",
            description: "Sommet central des Aiguilles de Chamonix.",
            dalles: [{ path: "meshes/1002_6540.drc", x: 1002, y: 6540 }, { path: "meshes/1002_6541.drc", x: 1002, y: 6541 }, { path: "meshes/1003_6540.drc", x: 1003, y: 6540 }, { path: "meshes/1003_6541.drc", x: 1003, y: 6541 }] 
          },
          { 
            id: "chamonix-needles", 
            name: "Aiguilles de Chamonix", 
            altitude: "3400m-3842m", 
            c2c: "https://www.camptocamp.org/waypoints/42284/fr/aiguilles-de-chamonix-et-envers-des-aiguilles-",
            description: "Enfilade mythique de pics granitiques (Blaitière, Grépon, Charmoz...).",
            dalles: [
                { path: "meshes/1002_6541.drc", x: 1002, y: 6541 }, { path: "meshes/1002_6542.drc", x: 1002, y: 6542 }, 
                { path: "meshes/1003_6541.drc", x: 1003, y: 6541 }, { path: "meshes/1003_6542.drc", x: 1003, y: 6542 }, 
                { path: "meshes/1003_6543.drc", x: 1003, y: 6543 }, { path: "meshes/1004_6542.drc", x: 1004, y: 6542 }
            ] 
          },
        ],
      },
      {
        ...
        children: [
          { 
            id: "mont-blanc", 
            name: "Mont Blanc (4810m)", 
            altitude: "4810m", 
            c2c: "https://www.camptocamp.org/waypoints/37399/fr/mont-blanc", 
            description: "Toit de l'Europe occidentale.",
            dalles: [{ path: "meshes/0999_6533.drc", x: 999, y: 6533 }, { path: "meshes/0999_6534.drc", x: 999, y: 6534 }, { path: "meshes/1000_6533.drc", x: 1000, y: 6533 }, { path: "meshes/1000_6534.drc", x: 1000, y: 6534 }] 
          },
          { 
            id: "tacul", 
            ...
            description: "Sommet massif entre l'aiguille du Midi et le mont Maudit.",
            waypoints: [{name: "Pilier Gervasutti", type: "Sommet"}, {name: "Aiguilles du Diable", type: "Crête"}, {name: "Triangle du Tacul", type: "Face N"}],
            dalles: [
              { path: "meshes/1002_6536.drc", x: 1002, y: 6536 }, { path: "meshes/1002_6537.drc", x: 1002, y: 6537 }, 
              { path: "meshes/1001_6536.drc", x: 1001, y: 6536 }, { path: "meshes/1001_6537.drc", x: 1001, y: 6537 }
            ] 
          },
          { 
            id: "maudit", 
            ...
            description: "Passage obligé de la traversée des Trois Monts.",
            dalles: [
              { path: "meshes/1000_6535.drc", x: 1000, y: 6535 }, { path: "meshes/1000_6536.drc", x: 1000, y: 6536 }, { path: "meshes/1001_6536.drc", x: 1001, y: 6536 }
            ] 
          },
          { 
            id: "dome-gouter", 
            name: "Dôme du Goûter (4304m)", 
            altitude: "4304m",
            c2c: "https://www.camptocamp.org/waypoints/37403/fr/dome-du-gouter", 
            dalles: [{ path: "meshes/0997_6534.drc", x: 997, y: 6534 }, { path: "meshes/0997_6535.drc", x: 997, y: 6535 }, { path: "meshes/0998_6534.drc", x: 998, y: 6534 }, { path: "meshes/0998_6535.drc", x: 998, y: 6535 }] 
          },
          { 
            id: "aiguille-gouter", 
            name: "Aiguille du Goûter (3863m)", 
            altitude: "3863m",
            c2c: "https://www.camptocamp.org/waypoints/37404/fr/aiguille-du-gouter", 
            dalles: [{ path: "meshes/0996_6536.drc", x: 996, y: 6536 }, { path: "meshes/0997_6535.drc", x: 997, y: 6535 }, { path: "meshes/0997_6536.drc", x: 997, y: 6536 }] 
          },
        ],
      },
      {
      ...
      },
      {
        ...
        children: [
          { 
            id: "jorasses", 
            name: "Grandes Jorasses (4208m)", 
            altitude: "4208m",
            c2c: "https://www.camptocamp.org/waypoints/37419/fr/grandes-jorasses", 
            description: "Une muraille de 1200m de haut, mythique face nord des Alpes.",
            waypoints: [{name: "Pointe Walker", type: "Sommet"}, {name: "Éperon Walker", type: "Pilier"}],
            dalles: [{ path: "meshes/1008_6538.drc", x: 1008, y: 6538 }, { path: "meshes/1008_6539.drc", x: 1008, y: 6539 }, { path: "meshes/1009_6538.drc", x: 1009, y: 6538 }, { path: "meshes/1009_6539.drc", x: 1009, y: 6539 }] 
          },
        ],
      },
    ],
...
function HomePageContent() {
  ...
  return (
    <div className="h-screen bg-slate-100 text-slate-900 font-sans overflow-hidden flex flex-col p-3 lg:p-4 gap-3">
      ...
      <main className="flex-1 flex gap-3 overflow-hidden">
        <aside className="w-[300px] flex-shrink-0 flex flex-col bg-white border border-slate-200 rounded-3xl p-6 shadow-sm overflow-hidden"> 
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar-light pr-2">
            {MOUNTAIN_TREE.map((root) => (
              <TreeElement key={root.id} item={root} selectedIds={selectedModels} onToggle={(id: any) => setSelectedModels([id])} />
            ))}
          </div>
        </aside>
                ...
                <div className="w-full h-full flex flex-col items-center justify-center p-8 lg:p-12">
                    <div className="max-w-2xl w-full text-center space-y-8">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 text-[10px] font-bold uppercase tracking-[0.2em]">Sélectionnez un sommet dans le répertoire</p>
                        </div>
                        <div className="grid grid-cols-2 gap-4 text-left">
                            <div className="p-5 bg-white/5 rounded-2xl border border-white/10"><div className="flex items-center gap-3 mb-2 text-blue-400"><MousePointer2 className="h-4 w-4"/><span className="text-[10px] font-bold">Rotation</span></div><p className="text-xs text-slate-400">Clic gauche ou MAJ + Clic.</p></div>
                            <div className="p-5 bg-white/5 rounded-2xl border border-white/10"><div className="flex items-center gap-3 mb-2 text-blue-400"><ZoomIn className="h-4 w-4"/><span className="text-[10px] font-bold">Zoom</span></div><p className="text-xs text-slate-400">Utilisez la molette.</p></div>
                        </div>
                    </div>
                </div>
            )}
              ...
              <div className="flex-1 overflow-y-auto p-8 space-y-10 custom-scrollbar-light">
                ...
                {selectedRouteInfo.c2c && (
                    <a href={selectedRouteInfo.c2c} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-5 bg-white border-2 border-blue-600 text-blue-600 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-blue-600 hover:text-white transition-all shadow-lg shadow-blue-100 active:scale-95 group">
                        <div className="flex items-center gap-3"><CamptocampLogo /> <span>Topo complet</span></div>
